...
Copy the contents of Topo_1.0.0.1 folder to the Documents/Topo folder.

To run the app server, double click of the Topo.exe file.
...
To loginto the Reporting application, ctrl-click on http://localhost:5000 to open in your browser.
